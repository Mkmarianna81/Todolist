...
import { onSnapshot, collection, doc, updateDoc, deleteDoc ,serverTimestamp,addDoc,
...
export const editTodo = async (id, todo) => {
 const docRef = doc(db, 'todolist', id)
 //setDoc(docRef,{todo})//azokat a mezőket amiket nem sorakoztatok fel kitörli (ezért nem ezt használjuk)
